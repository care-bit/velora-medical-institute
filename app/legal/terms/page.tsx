    ...
    <LegalPage
      ...
      sections={[
        ...
        },
        {
          heading: 'Contact',
          body: (
            <p>Questions about these terms can be directed to <a href="mailto:care@veloramedicalinstitute.com" className="underline underline-offset-2">care@veloramedicine.com</a>.</p>
          ),
        },
      ]}
    />
