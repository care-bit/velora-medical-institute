    ...
    <LegalPage
      ...
      sections={[
        ...
        },
        {
          heading: 'Contact',
          body: (
            <p>Questions about this policy can be directed to <a href="mailto:care@veloramedicalinstitute.com" className="underline underline-offset-2">care@veloramedicalinstitute.com</a>.</p>
          ),
        },
      ]}
    />
