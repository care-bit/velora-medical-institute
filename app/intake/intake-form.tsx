      ...
      <section className="bg-bone min-h-[60vh] py-24">
        <div className="container-narrow text-center">
          ...
          <div className="mt-12 flex flex-wrap items-center justify-center gap-3">
            <Link href="https://ehr.charmtracker.com/publicCal.sas?method=getCal&digest=169f4dd01960b6c31cb1f577544c70e574ed96d3d580cebc1192a3b4b068b2f4c791341ca9a05ba47b16a2ad35a972fba0ae868b6eb0918a" className="btn-primary">Book a Consultation <ArrowUpRight className="size-3.5" /></Link>
        ...
        <aside className="hidden lg:block lg:col-span-3 lg:sticky lg:top-32 self-start">
          ...
          <div className="mt-8 p-5 bg-paper border border-line">
            ...
            <p className="mt-3 text-[13.5px] text-ink-soft leading-relaxed">
              Email <a href="mailto:care@veloramedicalinstitute.com" className="text-ink underline underline-offset-2">care@veloramedicalinstitute.com</a> if you have questions while completing your intake.
            </p>
          </div>
        </aside>
